-- Properly fix timezone issue by using CURRENT_TIMESTAMP with timezone conversion
-- The issue is CURRENT_DATE in PostgreSQL uses the server's timezone (UTC)
-- We need to convert to America/New_York timezone first, then get the date
